...
# bpm = BeadPoolManifest('/home/arleg/repos/bead_array_files/data/BovineSNP50_v3_A1.bpm')
# print(dir(bpm))
...
print(bpm.map_infos)
print(bpm.addresses)
print(bpm.normalization_lookups)
print(bpm.ref_strands)
print(bpm.source_strands)
print(bpm.num_loci)
print(bpm.manifest_name)
print(bpm.control_config)
